...
#'
#' @param notes String, vector: Notes to highlight. 
#' Default = \code{buildScale("C4", "minor")}
...
cplot_piano <- function(notes = buildScale("C4", "minor"),
                        blackKey.col = "white") {
    notes0 <- notes
    notes <- formatNote(notes)
    bg <- if (blackKey.col == "white") {
        crayon::bgWhite
    } else {
        crayon::bgBlack
    }
    sel <- if (blackKey.col == "white") {
        crayon::bgCyan$black
    } else {
        crayon::bgCyan$white
    }
    ...
    cat("  | ", " |", col$n2(" "), "|", " |", col$n4(" "), "| ", " | ", " |",
        col$n7(" "), "|", " |", col$n9(" "), "|", " |", col$n11(" "), "|", 
        "  |  |", col$n14(" "), "|", " |", col$n16(" "), "| ", " | ", " |", 
        col$n19(" "), "|", " |", col$n21(" "), "|", " |", col$n23(" "), "|", 
        "  |  |", col$n26(" "), "\n",
        sep = ""
    )
    cat("  |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |\n")
    cat(
        "  |", col$n1("C"), "|", col$n3("D"), "|", col$n5("E"), "|",
        col$n6("F"), "|", col$n8("G"), "|", col$n10("A"), "|", col$n12("B"), 
        "|", col$n13("C"), "|", col$n15("D"), "|", col$n17("E"), "|", 
        col$n18("F"), "|", col$n20("G"), "|", col$n22("A"), "|", col$n24("B"), 
        "|", col$n25("C"), "|\n"
    )
